              ...
              <div class="icons col-1">
                <div class="trash-icon">
                  <trash-icon size="1.3x" class="custom-class" style="margin: auto;"
                   v-show="problem.creator == currentUid || user.is_admin"
                      ...
                      <div class="card" :ref="'cardSol'+problem.id">
                        <div class="card-header" id="headingTasks">
                          ...
                          <button class="btn btn-link btn-block text-left" style="width: 100%;" type="button"
                            data-toggle="collapse" @click="onClickSol(problem.id)" id="collapseTasks_btn"
                        ...
                        <div id="collapseTasks" class="collapse show" aria-labelledby="headingTasks"
                          data-parent="#tasks" style="width: 100%;">
                      ...
                      <div class="card">
                        ...
                        <div id="collapseResults" class="collapse" aria-labelledby="headingResults" style="width: 100%;"
                          ...
                          <div class="card-body row p-0" style="flex-direction: row;">
                            ...
                            <div class="col-4 p-2"
                              style="flex-direction: column;display: flex;min-height: 417px;max-height: 417px;">
    ...
    methods: {
      ...
      onClickSol(id) {
        if (document.getElementById('collapseTasks').classList.contains('show')) {
          ...
          this.$refs['cardSol' + id][0].style.minHeight = 'auto'
        } else {
